//! T-053 — NVENC Windows probe shape tests.
...
mod windows_tests {
    ...
    use cove_replay_engine::encoder::backends::nvenc::NvencBackend;

    #[tokio::test]
    async fn nvenc_windows_probe_returns_unavailable_not_implemented() {
    ...
    #[tokio::test]
    async fn nvenc_windows_teardown_returns_ok() {
...
#[cfg(not(windows))]
#[test]
fn nvenc_windows_tests_only_run_on_windows() {}
